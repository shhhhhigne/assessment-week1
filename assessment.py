...
def foods_in_common(foods1, foods2):
    ...
    **NOTE**: for this problem, you're welcome to use any of the
    ...
    return sorted([food for food in foods1 if food in set(foods2)])
...
def every_other_item(items):
    ...
    # for item in xrange(len(items)):
    #     if item % 2 == 0:
    #         every_other.append(items[item])

    # return every_other

    return [items[item] for item in xrange(len(items)) if item % 2 == 0]
...
def largest_n_items(items, n):
    ...
    #     if n == 0:
    #         return []
    #     elif len(n_largest) < n:
    #         n_largest.append(item)
    #     elif item > n_largest[0]:
    #         n_largest[0] = item
    #     n_largest.sort()
